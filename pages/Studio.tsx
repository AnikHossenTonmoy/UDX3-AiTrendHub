    ...
    <div className="min-h-screen bg-slate-50 dark:bg-dark-bg pb-24 font-sans">
        <div className="max-w-md mx-auto flex flex-col gap-6 pt-8 pb-4">
            <div className="px-4 text-center">
                ...
                <p className="text-slate-500 dark:text-slate-400 text-sm font-medium">Switch between intelligent chat and visual creation.</p>
            </div>
            ...
            <div className="px-4">
                <div className="bg-slate-200 dark:bg-slate-900/50 p-1.5 rounded-full flex relative border border-slate-300 dark:border-slate-700 shadow-inner h-14">
                    <div className={`w-1/2 h-full absolute top-0 p-1.5 transition-all duration-300 ease-out ${activeTab === 'Chat' ? 'left-0' : 'left-1/2'}`}>
                    ...
                    <button onClick={() => setActiveTab('Chat')} className={`flex-1 relative z-10 rounded-full text-sm font-bold flex items-center justify-center gap-2 transition-colors ${activeTab === 'Chat' ? 'text-slate-900 dark:text-white' : 'text-slate-500 hover:text-slate-700'}`}>
                        <span className="material-symbols-outlined text-[20px]">chat_bubble</span> Chat
                    </button>
                    <button onClick={() => setActiveTab('Image')} className={`flex-1 relative z-10 rounded-full text-sm font-bold flex items-center justify-center gap-2 transition-colors ${activeTab === 'Image' ? 'text-slate-900 dark:text-white' : 'text-slate-500 hover:text-slate-700'}`}>
                        <span className="material-symbols-outlined text-[20px]">image</span> Image
                    </button>
                </div>
            </div>
        </div>
            ...
            {activeTab === 'Image' && (
                <div className="flex flex-col gap-6 animate-fadeIn">
                    <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-6 text-white shadow-2xl overflow-hidden relative border border-slate-700">
                        ...
                        <div className="flex items-center justify-between mb-5 relative z-10"><div className="flex items-center gap-2"><div className="p-1.5 bg-white/10 rounded-lg"><span className="material-symbols-outlined text-yellow-400">palette</span></div><div><h3 className="font-bold text-base leading-none">NanoBanana Gen</h3></div></div></div>
